...
这里记录 MindFace-Lite 的工程设计、调试说明、部署说明和面试讲解材料。
...
- `03_realtime_engineering.md`：队列、延迟、FPS、实时工程设计。
- `04_cpp_control.md`：C++ CMake、队列、UDP、串口式输出。
- `05_rk3588_rknn_plan.md`：RK3588/RKNN 部署思路。
- `06_debugging.md`：常见错误与修复。
- `07_interview_notes.md`：面试讲解提纲。
- `08_performance_report.md`：性能报告摘要。

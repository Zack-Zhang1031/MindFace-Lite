...
struct Params { float open; float width; float round; };

std::vector<Params> load_csv(const std::string& path) {
...
int main(int argc, char** argv) {
    ...
    for (const auto& p : rows) {
        ...
        msg << "mouth_open=" << p.open << ",mouth_width=" << p.width << ",lip_round=" << p.round;
